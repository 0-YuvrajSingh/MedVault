...
VALUES 
    ...
    (gen_random_uuid(), 'Doctor John Doe', 'doctor@medvault.com', '$2a$12$R.P1eEw.3g7yT6gR6/Yp.enT.y8L01GzXy0H5XkYv8G9kP5hD1uXW', 'ROLE_DOCTOR', false, NOW()),
    (gen_random_uuid(), 'Patient Jane Doe', 'patient@medvault.com', '$2a$12$R.P1eEw.3g7yT6gR6/Yp.enT.y8L01GzXy0H5XkYv8G9kP5hD1uXW', 'ROLE_PATIENT', true, NOW());
