  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50" style={{
      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-lg border-b border-slate-200 shadow-sm">
        ...
        {mobileOpen && (
          <div className="md:hidden border-t border-slate-200 bg-white animate-fade-in shadow-md">
            <div className="px-4 py-3 space-y-1">
              ...
              <div className="pt-4 pb-2 border-t border-slate-200 flex flex-col gap-3">
