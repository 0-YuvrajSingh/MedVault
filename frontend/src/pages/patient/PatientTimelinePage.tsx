...
const PatientTimelinePage: React.FC = () => {
  const { data: events = [], isLoading, isError } = useTimelineEvents('patient');
      ...
      <div className="space-y-6 pb-12">
        ...
        <Card>
          <EmptyState
            ...
            description="An error occurred while fetching your timeline. Please try again."
          />
        </Card>
      </div>
    );
      ...
      {events.length === 0 ? (
        <Card>
          <EmptyState
            ...
            description="You don't have any upcoming events at this time."
          />
        </Card>
      ) : (
        <div className="ml-2">
