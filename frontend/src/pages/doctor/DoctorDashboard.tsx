      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {stats.map(s => (
                 <div key={s.label} className="bg-white rounded-xl p-5 border-2 border-black shadow-sm hover:shadow-md transition-all duration-300 group hover:-translate-y-1">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-xl border-2 border-black shadow-sm flex flex-col h-full overflow-hidden">
            <div className="p-6 border-b border-black border-2 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gray-50/50">
              ...
              <div className="relative w-full sm:w-64">
                ...
                <input type="text" placeholder="Search patients..." className="w-full pl-9 pr-4 py-2 bg-white border-2 border-black rounded-lg text-sm font-medium focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 transition-all shadow-sm" />
              </div>
            </div>
            ...
            <div className="p-0 overflow-x-auto flex-1">
              {patients.length === 0 ? (
                ...
                <table className="w-full text-left text-sm">
                  <thead className="bg-white text-gray-400 font-bold uppercase text-[10px] tracking-wider border-b border-black border-2">
                    ...
                    {patients.map(p => (
                      <tr key={p.id} className="hover:bg-teal-50/30 transition-colors group">
                        ...
                        <td className="px-6 py-4 text-right">
                          <Link to={`/doctor/patients/${p.id}/records`} className="inline-block px-4 py-2 bg-white border-2 border-black text-gray-700 hover:bg-teal-50 hover:border-teal-200 hover:text-teal-700 rounded-lg text-xs font-bold transition-all shadow-sm">
                            View File
                          </Link>
                        </td>
                      </tr>
