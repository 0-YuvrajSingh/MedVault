          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm flex flex-col h-full overflow-hidden">
            <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gray-50/50">
              ...
              <div className="relative w-full sm:w-64">
                ...
                <input type="text" placeholder="Search patients..." className="w-full pl-9 pr-4 py-2 bg-white border border-gray-200 rounded-lg text-sm font-medium focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 transition-all shadow-sm" />
              </div>
            </div>
                    ...
                    {patients.map(p => (
                      <tr key={p.id} className="hover:bg-teal-50/30 transition-colors group">
                        ...
                        <td className="px-6 py-4 text-right">
                          <Link to={`/doctor/patients/${p.id}/records`} className="inline-block px-4 py-2 bg-white border border-gray-200 text-gray-700 hover:bg-teal-50 hover:border-teal-200 hover:text-teal-700 rounded-lg text-xs font-bold transition-all shadow-sm">
                            View File
                          </Link>
                        </td>
                      </tr>
