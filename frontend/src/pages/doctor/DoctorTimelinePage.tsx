  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      <div className="page-header">
        ...
        <p className="text-sm text-slate-500 mt-1">Your upcoming schedule and recent activities</p>
      </div>
      ...
      <Card className="p-8 text-center border-dashed">
        ...
        <p className="text-slate-500">Your schedule is currently clear for the next 7 days.</p>
      </Card>
    </div>
  );
};
