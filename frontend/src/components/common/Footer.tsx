...
const Footer: React.FC<FooterProps> = ({ variant = 'public' }) => {
  ...
  if (variant === 'dashboard') {
    return (
      <footer className="mt-auto py-6 text-center text-xs text-gray-400 font-medium border-t border-slate-200 flex flex-col items-center justify-center gap-1">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <span className="text-xs text-gray-400 font-medium bg-gray-50 px-2.5 py-1 rounded-md border border-slate-200">
